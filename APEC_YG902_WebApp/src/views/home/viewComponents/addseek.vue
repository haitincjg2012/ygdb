<template>
  <div class="address-info-page-Seek">
...
<style>
   @import "../../../assets/css/addressSeek.css";
</style>
<script>
...
//              self.getthirAddrList(res.code)
      ...
      saveBtn(){
        ...
        var param = self.cityName +self.countyName;
        var obj = {
          cityId:self.city,
          areaId:self.county,
          townId:self.country,
        ...
        try {
          ...
          this.$store.state.addrSeekData = obj;
      ...
      historyRecord(evt){
        ...
        this.$store.state.addrSeekData = data;
        this.$router.go(-1);
      }
    },
    activated(){
