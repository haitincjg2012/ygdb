...
<template>
  <div class="newsPublish" id="formContainer">
    ...
    <form class="myform" >
      <div class="title">
        <!-- <input id="title"  type="text" placeholder="添加标题" v-model="myform.title" /> -->
      ...
      <!-- <div class="newsImg" v-if="true" > -->
          <span class="delBtn" @click="delImg">
            <img src="../../../assets/img/delIcon.png" />
          </span>
          <img :src="myform.url+'?x-oss-process=style/_detail_hq'" />
          <!-- <img src="https://yg-pro.oss-cn-qingdao.aliyuncs.com/4cd0ddf770bd87516553fc659e5f56e7?x-oss-process=style/_detail_hq" /> -->
      </div>
...
export default{
  ...
  methods:{
    ...
    issueNews(){
      var vm=this;
      var hasimage=vm.myform.url?true:false;
