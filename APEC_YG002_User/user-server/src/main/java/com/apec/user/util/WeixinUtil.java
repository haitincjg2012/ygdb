...
public class WeixinUtil {
    private static final String APPID = "wxee6451ec9806358e";
    private static final String APPSECRET = "U2FsdGVkX2bxsNNzP8ApeCetVxKyPA0w";
    ...
    private static JSONObject doGetStr(String url) throws IOException {
        ...
        return JsonUtil.parseObject(res);
    }
}
