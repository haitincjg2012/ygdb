 ...
 * @author xxx
 */
public abstract class AbstractUploadFtpUtils
{
    private static final Log log = LogFactory.getLog( AbstractUploadFtpUtils.class );
    ...
    public static InputStream getImageStream(BufferedImage bufferedImage, String imgSuffix)
    {
        ...
        {
            log.error( "It occured error in excuting AbstractUploadFtpUtils.getImageStream case:" + e );
        }
        return is;
    }
