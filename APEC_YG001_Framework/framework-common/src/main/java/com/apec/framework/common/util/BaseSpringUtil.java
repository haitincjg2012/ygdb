...
public abstract class BaseSpringUtil
{
    private final static Log log = LogFactory.getLog(BaseSpringUtil.class);
    private static ApplicationContext applicationContext;

    public static void setApplicationContext(ApplicationContext applicationContext)
    {
        BaseSpringUtil.applicationContext = applicationContext;
    }
    ...
    private static String getMessage(String code, Object[] args, String defaultMessage, Locale locale)
    {
        ...
        log.info("##################");
        log.info(applicationContext.getMessage( code, args, defaultMessage, locale ));
        log.info("##################");
