...
(function($){
        ...
        var settings = {
            ...
            $(this).after("<div class='zoomdiv'><img width='1000' height='1000' class='img_big' src='"+bigimage+"'/></div>");
            ...
            if(!settings.lens){
              $(this).css('cursor','crosshair');
                   ...
                   /*$("div.jqZoomPup").hide();*/
                    ...
                    var bigwidth = $(".img_big").get(0).offsetWidth;

                    var bigheight = $(".img_big").get(0).offsetHeight;
